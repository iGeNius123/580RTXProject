...
public class PhotonMap : MonoBehaviour {
    ...
    private ComputeBuffer _photonMap0;
    private ComputeBuffer _photonMap1;
    private List<Transform> _transformsToWatch = new List<Transform>();

    private List<Sphere> spheres = new List<Sphere>();
    private List<Photon> photonMap0 = new List<Photon>();
    private List<Photon> photonMap1 = new List<Photon>();
    ...
    private void Awake()
    {
        ...
        _transformsToWatch.Add(PointLight.transform);
    ...
    private void SetUpScene()
    {
        ...
        if (_photonMap0 != null)
            _photonMap0.Release();
        if (photonMap0.Count > 0)
        {
            _photonMap0 = new ComputeBuffer(photonMap0.Count, 40);
            _photonMap0.SetData(photonMap0);
        }
        ...
        if (photonMap0.Count > 0)
        {
            _photonMap1 = new ComputeBuffer(photonMap1.Count, 40);
            _photonMap1.SetData(photonMap1);
        }
    }
    ...
    private void SetShaderParameters()
    {
        ...
        if (_photonMap0 != null)
            RayTracingShader.SetBuffer(0, "_PhotonMap0", _photonMap0);
        if (_photonMap1 != null)
            RayTracingShader.SetBuffer(0, "_PhotonMap1", _photonMap1);
    }
